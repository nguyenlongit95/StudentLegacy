    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <form action="admin/Course/createCourse" method="POST" enctype="multipart/form-data">
                    <div class="col-md-9">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="name" id="name" class="form-control" placeholder="name of course">
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                    <!-- /.form group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="purpose" id="purpose" class="form-control" placeholder="purpose of course">
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                    <!-- /.form group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea name="description" class="form-control ckeditor" id="Descriptions" cols="30" rows="30"></textarea>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                    <!-- /.form group -->
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="fee" class="form-control" placeholder="Adminstator">
                            </div>
                            <!-- /.input group -->
                        </div>
                        <!-- /.form group -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="time_limit" class="form-control" placeholder="Time">
                            </div>
                            <!-- /.input group -->
                        </div>
                        <!-- /.form group -->
